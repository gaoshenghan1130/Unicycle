...
{
  /* Main_Motor */
  CUSTOM_STM_MM_READ_EVT,
  CUSTOM_STM_MM_WRITE_NO_RESP_EVT,
  CUSTOM_STM_MM_WRITE_EVT,
  CUSTOM_STM_MM_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_MM_NOTIFY_DISABLED_EVT,
  /* Balancer_Motor */
  ...
  CUSTOM_STM_UCC_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_UCC_NOTIFY_DISABLED_EVT,
  CUSTOM_STM_UCC_INDICATE_ENABLED_EVT,
  CUSTOM_STM_UCC_INDICATE_DISABLED_EVT,
  /* UcUpdater */
